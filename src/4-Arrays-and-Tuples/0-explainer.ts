...
function logMessages2(messages: ReadonlyArray<string>) {
  for (const message of messages) {
    console.log(message);
  }
...
// TS2345: Argument of type NameParts is not assignable to parameter of type string[]
// The type NameParts is readonly and cannot be assigned to the mutable type string[]
