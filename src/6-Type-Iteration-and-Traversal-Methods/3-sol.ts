...
// type FilterSensors<SensorList, AllowedTypes> = -> First를 그대로 보존하지 못함
//   SensorList extends [ { type: infer T, readings: infer R }, ...infer Rest ]
//     ? T extends AllowedTypes
//       ? [ { type: T, readings: R }, ...FilterSensors<Rest, AllowedTypes> ]
//       : [ ...FilterSensors<Rest, AllowedTypes> ]
//     : [];

type FilterSensors<SensorList, AllowedTypes> =
  SensorList extends [ infer First, ...infer Rest ]
